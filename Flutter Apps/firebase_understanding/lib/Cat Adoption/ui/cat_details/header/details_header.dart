...
import 'package:firebase_understanding/Cat%20Adoption/ui/cat_details/header/cat_colored_images.dart';
...
class _CatDetailsHeaderState extends State<CatDetailsHeader> {
  ...
  Widget build(BuildContext context) {
    ...
    //Action Buttons
    var actionButtons = new Padding(padding: const EdgeInsets.only(top: 16.0,
    left: 16.0,
      right: 16.0
    ),
      child: new Row(
    ...
    return new Stack(
      children: [
        ...
        new Positioned(child: new BackButton(color: Colors.white,),
        top: 26.0,
          left: 4.0,
        ),
      ],
